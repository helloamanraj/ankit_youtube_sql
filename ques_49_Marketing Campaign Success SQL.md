Question 49:
https://www.youtube.com/watch?v=m_oDI0bD6VQ&list=PLBTZqjSKn0IeKBQDjLmzisazhqQy4iGkb&index=49

Marketing Campaign Success SQL
...
, rank() over (partition by user_id order by created_at) as rw_user_id
